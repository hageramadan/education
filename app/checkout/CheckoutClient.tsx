      ...
      <div className="min-h-screen bg-gradient-to-l from-[#bdcbf12a] to-[#feecea3b] flex items-center justify-center px-4">
        <div className="text-center max-w-md bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-500 mb-4">
            {t('checkout.orderNumber')}: <span className="font-bold text-[#1A834B]">{searchParams.get('order_number')}</span>
          </p>
          <p className="text-gray-400 text-sm mb-6">{t('checkout.redirecting')}</p>
          <div className="flex justify-center">
            <div className="w-8 h-8 border-2 border-[#1A834B] border-t-transparent rounded-full animate-spin"></div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="container page-with-padding mx-auto mb-3">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
            <Link href="/cart" className="hover:text-[#1A834B] transition">
              {t('checkout.cart')}
            </Link>
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#1A834B] font-medium">{t('checkout.checkoutTitle')}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1A834B] transition"
                  />
                </div>
            ...
            <button
              ...
              className="hidden md:block w-full bg-[#1A834B] text-white py-3 rounded-xl font-semibold text-lg transition disabled:opacity-50"
            >
          ...
          <div className="lg:col-span-1">
            ...
            <button
              onClick={handleSubmit}
              disabled={isSubmitting || isOrderCompleted}
              className="md:hidden block w-full bg-[#1A834B] text-white py-3 rounded-xl font-semibold text-lg transition disabled:opacity-50"
            >
              {isSubmitting ? t('checkout.processing') : t('checkout.confirmOrder')}
            </button>
          </div>
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-xl max-h-[90vh] overflow-y-auto">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={t('checkout.fullNamePlaceholder')}
                className={`w-full ps-10 pe-3 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1A834B] transition ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full ps-10 pe-10 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#1A834B] transition ${
        ...
        <div className="p-6 border-t border-gray-100 flex gap-3">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 bg-[#1A834B] text-white py-2.5 rounded-xl font-medium hover:bg-[#2ECC71] transition"
          >
            {t('checkout.createAccount')}
          </button>
        </div>
        ...
        <div className={`grid ${isGuest ? 'grid-cols-1' : 'grid-cols-2'} gap-2 md:gap-5 mx-auto px-4 md:px-5 mb-5`}>
          ...
          {!isGuest && (
            <button
              ...
              className="w-full bg-[#1A834B] text-white py-2 rounded-xl font-medium hover:bg-[#2ECC71] transition"
            >
              {t('checkout.myOrders')}
            </button>
          )}
